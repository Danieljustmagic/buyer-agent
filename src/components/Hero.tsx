...
export default function Hero() {
  return (
    <section className="relative min-h-screen bg-night flex items-center overflow-hidden">
      ...
      {/* Halo ambre – discret */}
      <div
        className="absolute bottom-0 right-0 w-[600px] h-[600px] opacity-[0.06] pointer-events-none"
        style={{
      ...
      <div className="relative max-w-5xl mx-auto px-6 md:px-12 pt-32 pb-24 w-full">
        <div className="max-w-2xl">
          ...
          {/* Titre */}
          <h1 className="text-4xl md:text-5xl lg:text-[3.25rem] font-extrabold text-white leading-[1.1] mb-6">
          ...
          {/* Ligne de séparation */}
          <div className="w-8 h-0.5 bg-accent/40 mb-8" />
          ...
          <ul className="space-y-3 mb-12">
            {[
              ...
              <li key={item} className="flex items-center gap-3 text-white/75 text-base">
        ...
        <div className="mt-24 pt-8 border-t border-white/8 grid grid-cols-3 gap-8 max-w-md">
          {[
            ...
            <div key={s.l}>
              ...
              <div className="text-xs text-white/30 mt-1 leading-snug">{s.l}</div>
            </div>
          ))}
        </div>
      </div>
